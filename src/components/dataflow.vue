...
export default {
	...
	methods: {
		...
		DailyJump(date) {
          this.$router.push({name: 'errortask', params: { data: date,fre:'daily',specific:'1',module:'Dataflow'}})
		},
		WeeklyJump(date) {
		  this.$router.push({name: 'errortask', params: { data: date,fre:'weekly',specific:'1',module:'Dataflow'}})
		},
		MonthlyJump(date) {

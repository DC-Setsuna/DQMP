...
export default {
	...
	methods: {
		...
		DailyJump(date) {
          this.$router.push({name: 'errortask', params: { data: date,fre:'daily',specific:'1',module:'Account'}})
		},
		WeeklyJump(date) {
		  this.$router.push({name: 'errortask', params: { data: date,fre:'weekly',specific:'1',module:'Account'}})
		},
		MonthlyJump(date) {

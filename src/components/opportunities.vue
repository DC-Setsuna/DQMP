...
export default {
	...
	methods: {
		...
		DailyJump(date) {
          this.$router.push({name: 'errortask', params: { data: date,fre:'daily',specific:'1',module:'Opportunities'}})
		},
		WeeklyJump(date) {
		  this.$router.push({name: 'errortask', params: { data: date,fre:'weekly',specific:'1',module:'Opportunities'}})
		},
		MonthlyJump(date) {
		  this.$router.push({name: 'errortask', params: { data: date,fre:'monthly',specific:'1',module:'Opportunities'}})
		},
		//获取cookie
		getCookie(cname) {
		  var name = cname + "=";
